...
public class LinkedListTester {
  ...
  public void testContains() {
    LinkedList<Integer> list = new LinkedList<Integer>();
    assertFalse("Testing empty list", list.contains(0));
    list.addToFront(3);
    assertTrue("Testing one node", list.contains(3));
    list.addToFront(2);
    list.addToFront(1);
    assertTrue("Testing multiple nodes (first)", list.contains(1));
    assertTrue("Testing multiple nodes (middle)", list.contains(2));
    assertTrue("Testing multiple nodes (last)", list.contains(3));
  }
